...
CREATE TABLE IF NOT EXISTS `farmacia`.`produtos_compra` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_produtos_compra_idx` (`id_compra` ASC) VISIBLE,
  INDEX `fk_produtos_compra_idx1` (`id_produto` ASC) VISIBLE,
  CONSTRAINT `fk_produtos_compra`
...
CREATE TABLE IF NOT EXISTS `farmacia`.`receitas_medicas` (
  ...
  INDEX `fk_receitas_medicas_1_idx` (`id_produto_compra` ASC) VISIBLE,
